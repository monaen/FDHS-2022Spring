...
* Start the Anaconda Prompt application from your computer.
...
* Direct to the project folder (e.g. <code style="color:#fff;background-color:#2f3d48;border-radius: 4px;border: 1px solid #737b83;padding: 2px 4px">F:\DHLO2021_project</code>) where you saved your project files.
